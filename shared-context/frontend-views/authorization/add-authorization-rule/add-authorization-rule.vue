<template>
    <Form
        ...
        v-slot="{ errors }">
        <yim-sidebar :header="$t('Create user right')">
            <yim-sidebar-steps>
                <yim-sidebar-step>
                    {{ $t('Information') }}
                </yim-sidebar-step>
        ...
        <form-steps :has-management-sidebar-detail-form="true">
            ...
            <form-step v-else-if="hasInitialData === true">
                        ...
                        <form-step-items :title="$t('Information')">
                            <form-step-item>
                                <form-field-text
                                    ...
                                    type="text"
                                    rules="required"
                                    data-cy="form-field-text-information"
                        ...
                        <form-step-items :title="$t('Processrights')">
                            ...
                            <form-step-item>
                                <form-field-select
                                    ...
                                    text-field="text"
                                    data-cy="form-field-select-company-access-level"
                                    value-field="value">
                                </form-field-select>
                            </form-step-item>
        ...
        <yim-form-controls>
            ...
            <yim-form-control
                v-if="hasInitialData === true"
                :disabled="actionButtonIsDisabled"
                data-cy="button-add"
                @click.native="addAuthorizationRule">
                {{ $t('Create') }}
            </yim-form-control>
        </yim-form-controls>
    </Form>
...
<script lang="ts" src="./add-authorization-rule.ts"></script>
